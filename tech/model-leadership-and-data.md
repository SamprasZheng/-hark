...
**DeepSeek 衝擊的真相（反同溫層校正）：** R1 推理價 $0.55/$2.19 每百萬 in/out，較 o1 便宜 ~27×[d]，2025/1 引爆全球科技股拋售（憂 Nvidia）。但 (a) 宣稱 $294K 訓練費被 The Register/CNN 打臉，真實 V3+R1 約 $5.9M、算力與 Llama 4 同級，「便宜訓練」被誇大[d2]；(b) 最關鍵——**開源權重企業市占不增反減：19%(redacted)→11%(redacted)，中國開源僅佔總 API ~1%**[4]。即「scale is everything」被鬆動，但「便宜開源將顛覆閉源」的敘事被企業付費數據證偽。**可投資層結論見 CHOKEPOINTS。**
