...
1. **SWE-bench Verified progression** — verify: swebench.com / tbench.ai monthly. Status: leaders 88–89%, preview ~94% [2][5]. Next check: does any model break a *durable >5pt* lead (would re-open A1 moat)? **Falsifier:** sustained gap → labs disintermediate wrappers.
