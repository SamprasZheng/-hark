...
| [[consumer-credit-stress]] | 結構 | AMBER(plateau) | 總經 gap-fill(變數#6/7);**RISK GAUGE 非 chokepoint(A4=0)**;次級車貸 60+ 6.90%(32 年高但減速)+ BNPL 買菜翻倍至 29% 真實,但已實現放款數據改善、K 型隔離在底層;當防禦 overlay 看勞動上游觸發,不是交易 |
