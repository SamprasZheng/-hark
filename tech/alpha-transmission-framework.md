...
- **Concentration extreme cuts both ways** — Goldman's century study shows extreme concentration can mark *bottoms* (1932), and de-concentration can resolve *up* (laggards catch up), not only down.
