...
Qlib is Microsoft Research Asia's open-source AI-oriented quantitative investment platform (2020). The most architecturally-aligned project the operator could borrow from for `$hark`'s Phase 4–5 work:
