...
most — this sleeve is exactly how the (speculative sleeve) graveyard (−90/−100% husks) was built.
...
- **price-heat HIGH + ZERO confirmed evidence → `PURE-HYPE-NO-EVIDENCE`** — a
  *warning*, never a buy. This is exactly the (speculative sleeve)-graveyard pattern (chasing a
