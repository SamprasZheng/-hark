...
Tracked in [[working-tree-playful-map]] §4 and §5 (post-commit execution sequence): the actual code for any of the above. This proposal is documentation-only. Code lands phase by phase after human review per the `_proposals/` workflow in [[README]].
