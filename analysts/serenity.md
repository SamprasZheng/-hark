...
顯然有一家公司叫：AP Memory (redacted)。市值 48 億美元，已獲得認證。
...
Pan Jit (redacted) ~$1,6B
Eris Tech (redacted) ~$532M MC
Advanced Power Electronics (redacted) ~$565M MC
Inergy Technology (redacted) ~$202m MC
Potens (redacted) ~$170M 
...
-> Compeq (redacted)：「已從主要營運商獲得訂單，包括 Starlink 和 Amazon 的 Kuiper 計畫」 - 市值 96 億美元
...
TASC (redacted) 如果人們想看看或感到好奇。我大概會跳過，但這裡可能有些有趣的東西。
...
台股更多CPO/光通信供應鏈Nextronics (redacted)：光學組裝/共封裝基板等，Foxconn等訂單相關。 
...
至於台灣散熱相關股票：Kaori (redacted)、Sunon (redacted)、Auras (redacted)、Jentech (redacted)、AVC (redacted)。
...
FOCI (redacted) 在 $HIMX 財報電話會議後，現在市值約 32 億美元，看起來超級吸引人。我個人已將其列為較大的持倉之一。
...
關於 $JBL、$SMHMD、QD laser 和其他我放棄的隨機筆記：

1. $JBL：在 280 億美元時非常有前景。如果明年達到 450 億美元市值，我也不會感到驚訝。有點像西方 Innolight 在收購 Intel 的 siph ip 之後的情況。

前瞻本益比大約 ~22 倍，到 2027 年壓縮到低於 18 倍。

考慮到 $COHR 正在做的總可尋址市場擴張可能性，這真的很不錯？我目前更偏好 Coherent，但可能會再看看這個。Jabil 很難錯過？

不知道，正在掙扎是繼續集中投資 $COHR 還是分散。

2. IntelliEPI 正在調查，因為對 inp 外延相關東西感興趣，他們最近獲得了芯片法案補貼。還沒時間深入。

3. $SMHD - 去年因為毒性融資原因放棄，當時在看玻璃基板相關，但決定再看看。

Q1 - 3000 萬美元可轉換票據，所以那是稀釋陰影，不算太糟。
F1 轉售：4660 萬新股發行，註冊高達 9500 萬股轉售
所以那大概是從 3.03 億美元市值中減去 5.63 億美元？

就像他們可能作為基本供應商向 $AMAT、Ibiden、Unimicron 這類客戶供貨，但不確定是否能抵消稀釋？

4. 再次看量子點激光 / BTO 對比 ELS 和其他... 就像 QD laser 或 $ALMU 這類名稱一樣，現在還太早，可能一年後再回頭看。

我更喜歡 QD laser，因為它是富士通資助/分拆的，所以你可能不會像 $POET 投資者那樣遇到美國量子點研發的稀釋核彈？

話雖如此，確實有一些有趣的名稱，可能只是以防萬一投資一兩個量子名稱，以防有突破。

5. 然後出於好奇更深入調查 Furukawa 和 $AVGO 的關係。他們有巨大的製造規模，例如 2025 年資本支出擴張 ~500%。所以如果 2027-2028 年激光出現瓶頸，記住 Furukawa、Win semi 和其他將受益。

但我不認為會像 EML 瓶頸那麼嚴重？誰知道呢。

6. 接下來可能會調查 Yuanjie，有點像中國光子計劃的領導者，我認為它供應給 Innolight 和其他。從初步看來，看起來是個吸引人的長期投資？但除非它像 Unitree 那樣被嚴重低估，我不會個人投資。

這些名稱我都沒有持倉，只是丟一些想法，以防有用。



$IBM Starling 於 2029 年成立（順便說一句，名字很酷）。

鴻海在他們的會議上標示量子商業化將於 2030 年進行，這真的很有趣。2027 年原型製作。

這只是給外面的 $QBTS $RGTI $IONQ 兄弟們的一些有用的時間表

量子是我不那麼熟悉的領域，但僅從投資角度來看，因為它很熱門，也許 2028 年下半年或 2029 年上半年是量子搶跑的好時機，除非有什麼隨機的突破？

現在發生的一切看起來都太早了。通常在原型製作階段充當稀釋不是個好主意。

但只是分享我在量子運算商業化時間表預估方面看到的 2030 年時間表的有趣筆記。
...
對 Nvidia 生態系統的功率半導體 / SiPH 曝光。

光子學方面目前正透過 Nvidia 進行評估。功率半導體曝光透過 NVtS 和 powl，約 1.29 倍帳面價值，歐盟晶片法案擔保。美國晶片法案補助正在進行中。

約 12.8 億美元市值，今天應是歐盟晶片法案第二輪的受益者，作為催化劑。
