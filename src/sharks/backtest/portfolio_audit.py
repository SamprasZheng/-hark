...
# employer RSU/ESPP employer-comp exposure dominates total liquid-ish exposure but
...
CONCENTRATION_CONTEXT_USD = {
    ...
    "complementary_p2": 3_000,  # (speculative sleeve) (redacted) — small, not fully snapshotted; rough est
}


def build_concentration_context() -> dict:
    """Surface the RSU-dominated true exposure alongside the active-book
    ...
    return {
        "note": (
            "employer RSU/ESPP is NOT in portfolio_1_audit / portfolio_2_audit by "
...
def main():
    ...
    # Add a few employer RSU-related
