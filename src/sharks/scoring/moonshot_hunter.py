...
how the principal's (speculative sleeve) graveyard (the dead account of chased hype) happened. So
...
def moonshot_score(
    ...
    CRITICAL DISCIPLINE — the pure-hype warning:
      ...
      is flagged "PURE-HYPE-NO-EVIDENCE". This is the (speculative sleeve)-graveyard pattern:
    ...
    return {
        ...
        "note": (
            ...
            "the (speculative sleeve)-graveyard pattern. Find the insider/partnership/supply-chain "
